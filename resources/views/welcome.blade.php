...
<head>
    ...
    <title>{{ config('app.name', 'Gestión de Alumnos') }}</title>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:ml-6 sm:flex sm:items-center space-x-4">
                            @if (Route::has('login'))
                                @auth
                                    <a href="{{ url('/dashboard') }}" class="px-3 py-2 text-sm font-medium text-gray-700 hover:text-gray-900">Dashboard</a>
                                @else
                                    <a href="{{ route('login') }}" class="px-3 py-2 text-sm font-medium text-gray-700 hover:text-gray-900">Iniciar sesión</a>

                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="ml-4 px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700">Registrarse</a>
                                    @endif
                                @endauth
                            @endif
                        </div>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    <div class="text-center">
                        <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                            <span class="block">Gestión de Alumnos</span>
                            <span class="text-2xl block text-indigo-600">Aplicación para desplegar usando servicios  AWS</span>
                        </h1>
                        <p class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                            Verifica Administra la información de tus estudiantes de manera fácil y rápida con nuestra plataforma de gestión educativa.
                        </p>
                        <div class="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
                            ...
                            <div class="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                                <a href="#caracteristicas" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 bg-white hover:bg-gray-50 md:py-4 md:text-lg md:px-10">
                                    Saber más
                                </a>
                            </div>
                        </div>
                ...
                <div class="bg-indigo-700">
                    <div class="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
                        ...
                        <p class="mt-4 text-lg leading-6 text-indigo-200">
                            Crea una cuenta ahora y comienza a gestionar a tus alumnos de manera eficiente.
                        </p>
            ...
            <footer class="bg-white">
                <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
                    <p class="mt-8 text-center text-base text-gray-400">
                        &copy; {{ date('Y') }} Gestión de Alumnos. Todos los derechos reservados.
                    </p>
                </div>
            </footer>
        </div>
